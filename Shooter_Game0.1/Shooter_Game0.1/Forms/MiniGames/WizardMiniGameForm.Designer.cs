// File: Forms/MiniGames/WizardMiniGameForm.Designer.cs
namespace Shooter_Game0._1.Forms.MiniGames
{
    partial class WizardMiniGameForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            _countdownLabel.Text      = "Time: 8.0s";
            _countdownLabel.TextAlign = ContentAlignment.MiddleCenter;
            //
            // _legendLabel
            //
            _legendLabel.Font      = new Font("Segoe UI", 9F, FontStyle.Italic);
            _legendLabel.ForeColor = Color.FromArgb(200, 160, 255);
            _legendLabel.Location  = new Point(10, 58);
            _legendLabel.Name      = "_legendLabel";
            _legendLabel.Size      = new Size(470, 18);
            _legendLabel.Text      = "Hint: The real one is LARGER and PURPLE!";
            _legendLabel.TextAlign = ContentAlignment.MiddleCenter;
            //
            // _gamePanel
            //
            _gamePanel.BackColor  = Color.FromArgb(28, 15, 40);
            _gamePanel.BorderStyle = BorderStyle.FixedSingle;
            _gamePanel.Location   = new Point(10, 80);
            ...
            _blinkOverlay.Location  = new Point(10, 80);
