...
namespace Shooter_Game0._1_Tests
{
    public class Tests
    {
        ...
        public void TestDefaultMapConstructor()
        {
            ...
            string[,] terrain = defaultMap.Terrain;
            ...
            Assert.AreEqual(terrain, defaultMap.Terrain);
        ...
        {
            string username = "Teollite";
            IUser user = new User(username);
            Assert.AreEqual(user.Username, username);
            Assert.AreEqual(user.DamageDealt, 0);
            Assert.AreEqual(user.EnemiesKilled, 0);
