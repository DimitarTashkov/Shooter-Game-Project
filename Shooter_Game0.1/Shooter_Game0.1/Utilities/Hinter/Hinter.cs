...
namespace Shooter_Game0._1.Utilities.Hinter
{
    public static class Hinter
    {
        ...
        private static Dictionary<int,int> EnemiesRightFromPointer(int pointerXCoordinate, int pointerYCoordinate, string[,] terrain, Dictionary<Dictionary<int, int>, IEnemy> enemiesCoordinates)
        {
            bool isFound = false;
        ...
        private static Dictionary<int, int> EnemiesLeftFromPointer(int pointerXCoordinate, int pointerYCoordinate, string[,] terrain, Dictionary<Dictionary<int, int>, IEnemy> enemiesCoordinates)
        {
            bool isFound = false;
            Dictionary<int, int> returnData = new Dictionary<int, int>();
        ...
        private static Dictionary<int,int> ReturnClosestEnemy(int pointerXCoordinate, int pointerYCoordinate, string[,] terrain, Dictionary<Dictionary<int, int>, IEnemy> enemiesCoordinates)
        {
            int leftSumSteps = 0;
            int rightSumSteps = 0;
            Dictionary<int, int> leftEnemies = Hinter.EnemiesLeftFromPointer( pointerXCoordinate,  pointerYCoordinate,  terrain, enemiesCoordinates);
            Dictionary<int, int> rightEnemies = Hinter.EnemiesRightFromPointer(pointerXCoordinate, pointerYCoordinate, terrain, enemiesCoordinates);
