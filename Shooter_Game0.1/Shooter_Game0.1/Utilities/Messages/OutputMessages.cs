...
namespace Shooter_Game0._1.Utilities.Messages
{
    public static class OutputMessages
    {
        ...
        public static string EnemyWasKilled = "{0} enemy was successfully killed with {1} in coordinate {2}:{3} ! Enemies left {4}";
        ...
        public static string HintClosestDownEnemy = "The closest enemy is on {0}:{1} coordinate! ";
        public static string HintClosestUpEnemy = "The closest enemy is on {0}:{1} coordinate !";
